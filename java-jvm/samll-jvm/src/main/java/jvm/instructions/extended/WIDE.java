...
import jvm.instructions.loads.iload.ILOAD;
import  jvm.instructions.loads.aload.ALOAD;
import  jvm.instructions.loads.dload.DLOAD;
import  jvm.instructions.loads.fload.FLOAD;
import  jvm.instructions.loads.lload.LLOAD;
import  jvm.instructions.math.iinc.IINC;
import  jvm.instructions.stores.astore.ASTORE;
import  jvm.instructions.stores.dstore.DSTORE;
import  jvm.instructions.stores.fstore.FSTORE;
import  jvm.instructions.stores.istore.ISTORE;
import  jvm.instructions.stores.lstore.LSTORE;
